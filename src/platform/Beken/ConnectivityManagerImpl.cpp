...
int ConnectivityManagerImpl::netif_event_cb(void *arg, event_module_t event_module,
...
int ConnectivityManagerImpl::wlan_event_cb(void *arg, event_module_t event_module,
                                    int event_id, void *event_data)
{
    switch(event_id){
